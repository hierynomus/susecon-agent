...
Common labels
*/}}
{{- define "susecon-agent.labels" -}}
helm.sh/chart: {{ include "susecon-agent.name" . }}-{{ .Chart.Version }}
{{ include "susecon-agent.selectorLabels" . }}
